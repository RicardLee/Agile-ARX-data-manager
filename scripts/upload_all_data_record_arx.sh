...
SOURCE_DIR="/home/arx/data/"
TARGET_DIR="ceph-manipS1:manip_S1/myData-A1/real/raw_data/arx_lift2"
...
CONFIG_PATH="/home/arx/Desktop/device.config"
...
# 获取 IP 地址
IP_ADDRESS=$(ip -4 addr show enp45s0 | grep -oP '(?<=inet\s)\d+\.\d+\.\d+\.\d+')
