...
# Start Collection Mode Script
# This script starts the ROS system in collection mode (mode:=0) for data collection
# Usage: ./start_collection_mode.sh <COBOT_MAGIC_PREFIX>
...
echo "Collection mode started successfully" 